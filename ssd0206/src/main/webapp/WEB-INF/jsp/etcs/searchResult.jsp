...
<form name="form" method="POST" >
	<div align='center'><h1>" ${keyword } " 검색 결과</h1></div>
	<c:if test="${!empty resultSalesItems}" >
	<div align='center'><h3>일반 상품 목록</h3></div>
	<div class="kind_1_project">
		<table>
			<tr>
				<c:forEach var="i" items="${resultSalesItems }" varStatus="vs">
					<td>
	...
	<c:if test="${!empty resultACItems}" >
	<div align='center'><h3>경매 목록</h3></div>
	<div class="kind_1_project">
		<table>
			<tr>
				<c:forEach var="i" items="${resultACItems }" varStatus="vs">
					<td>
	...
	<c:if test="${!empty resultGBItems}" >
	<div align='center'><h3>공동구매 목록</h3></div>
	<div class="kind_1_project">
		<table>
			<tr>
				<c:forEach var="i" items="${resultGBItems }" varStatus="vs">
					<td>
